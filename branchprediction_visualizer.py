...
def find_best_sequences_by_absdiff(length):  
    ...
    for sequence in all_sequences:  
        ...
        one_bit_accuracy, two_bit_accuracy = compute_accuracies(sequence)  
...
def plot_sequences(max_length):  
    ...
    plt.savefig(f'best_sequences_{max_length}.png')
...
def plot_percentage_better_1bit(max_length):  
    ...
    ax.grid(True)  
    plt.savefig(f'percentage_better_1bit_{max_length}.png')
    plt.close(fig)  # Close the plot to free up memory
